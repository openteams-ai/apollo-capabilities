...
- [`SCHEMA.md`](SCHEMA.md) — human-readable schema, semantics, and compatibility notes
...
The JSON Schema validates the current manifest structure. The Markdown spec documents semantics and compatibility details that are awkward or impossible to express purely in JSON Schema.
